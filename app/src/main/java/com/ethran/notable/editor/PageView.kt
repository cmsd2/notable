...
import com.ethran.notable.editor.canvas.ViewEventBus
...
//    private var dbImages = appRepository.imageRepository
    ...
    init {
        ...
        // mean "the editor on screen", which with one editor is whichever PageView exists.
